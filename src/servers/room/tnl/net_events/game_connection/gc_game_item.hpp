...
public:
	...
	GCGameItem() : GameNetEvent{ GC_GAME_ITEM, NetEvent::GuaranteeType::GuaranteedOrdered, NetEvent::DirServerToClient} {}

	GCGameItem(U8 cmd, std::vector<GCGameItem::Item> items, U32 weaponIdentifier = 0x00) : GameNetEvent{ GC_GAME_ITEM, NetEvent::GuaranteeType::GuaranteedOrdered, NetEvent::DirServerToClient }
	{
		this->cmd = cmd;
		this->items = items;
