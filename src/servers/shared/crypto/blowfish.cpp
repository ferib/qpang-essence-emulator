...
void BlowfishContext::Initialize(BlowfishContext::CryptoType crypto)
{
	try
	{
		switch (crypto)
...
BlowfishContext::Key BlowfishContext::GetKeyPart()
{
...
void BlowfishContext::Decrypt(std::vector<char>& buffer, BlowfishContext::CryptoType crypto)
{
	switch (crypto)
	{
...
void BlowfishContext::Encrypt(std::vector<char>& buffer, BlowfishContext::CryptoType crypto)
{
	switch (crypto)
	{
...
//Credits: Bill Lynch
BlowfishContext::Key BlowfishContext::GenerateRandomKey()
{
	Key ret;
